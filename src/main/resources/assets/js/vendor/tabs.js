...
(function ($) {
    function Tabs(element) {
        ...
        this.setActiveTab = function() {
            ...
            else if (that.tabLinks.filter('.js-tabs__link--preselected').length > 0) {
                that.selectedTabLink = that.tabLinks.filter('.js-tabs__link--preselected').eq(0);
                that.selectedPanel = that.panels.filter('.js-tabs__panel--preselected').eq(0);
            }
            else {
